...
output_path = r"g:\My Drive\2026-theo-github\theo-armour-sandbox\cookbook\2025-taxes\gemini\chase-4127\payee_totals_4127.md"
...
with open(output_path, 'w', encoding='utf-8') as out:
    out.write("# Credit Card Payee Totals (Chase 4127 - 2025)\n\n")
    out.write("| Payee/Description | Total Amount |\n")
    out.write("| :--- | :--- |\n")
    for payee, total in sorted_totals:
        out.write(f"| {payee} | ${total:,.2f} |\n")

print(f"Successfully calculated payee totals and saved to {output_path}")
